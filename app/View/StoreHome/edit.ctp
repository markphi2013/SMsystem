<div class="groups form users-index program-body">
	...
	<td>
	<?php 
	echo $this->Form->input('product_id', array('label' => __('Product Name'),'id' => 'product-name'));
	//$this->Js->set('storeUpdateOptions', $r);
	...
	<tr><td><?php echo $this->Form->input('supplier_id', array(
	    'label' => __('Supplier name'),
	    'id' => 'supplier-name',
	    'readonly' => true)); ?></td></tr>
	<tr>
	<td class="carton-input"><?php  echo $this->Form->input('previous_cartons', array(
	    'label' => __('Previous carton'),
	    'id' =>'previous-carton')); ?></td>
