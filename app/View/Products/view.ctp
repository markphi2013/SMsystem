...
<h3><?php  echo __('Product');?></h3>
	<dl>
		...
		<dd>
			<?php echo h($product['Supplier']['supplier_name']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Product'), array('action' => 'delete', $product['Product']['id']), null, __('Are you sure you want to delete "%s" product?', $product['Product']['product_name'])); ?> </li>
